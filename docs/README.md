...
| `CODEX_HANDOFF.md` | Practical handoff context, current constraints, and future-agent notes. |
...
- If a constraint or unresolved issue should be visible to future agents, record it in `CODEX_HANDOFF.md`.
