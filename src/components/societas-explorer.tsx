        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-2 leading-relaxed">
              Adjust society&rsquo;s structural inputs below to simulate causal feedback loops. Watch how resource allocation, institutional strength, and connectivity shift civilizational outcomes.
            </p>
          </div>
