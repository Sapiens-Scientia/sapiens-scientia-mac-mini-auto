import type { DataIndexCategory, DataIndexEntry } from "@/lib/earth-systems";
...
export type DataIndexCatalogSection = {
  name: string;
  title: string;
  color: string;
  description: string;
...
export const dataIndexCatalog: DataIndexCatalogSection[] = [
  {
    "name": "General Knowledge",
    "title": "General Knowledge Databases",
    "color": "#2dd4bf",
    "description": "Large structured or full-content repositories for encyclopedic, cultural, and web-scale knowledge.",
    "items": [
      {
        "name": "Wikipedia",
  ...
  },
  {
    ...
    "color": "#7dd3fc",
    "description": "Citation indexes, metadata graphs, search engines, and research intelligence databases for scholarly literature.",
    "items": [
      {
        "name": "Google Scholar",
  ...
  },
  {
    ...
    "color": "#34d399",
    "description": "Biomedical literature, full text, trials, sequences, proteins, genomes, and structures.",
    "items": [
      {
        "name": "PubMed",
  ...
  },
  {
    ...
    "color": "#a78bfa",
    "description": "Field-specific systems for physics, astronomy, mathematics, and fast-moving research communities.",
    "items": [
      {
        "name": "arXiv",
  ...
  },
  {
    ...
    "color": "#fbbf24",
    "description": "Catalogs and repositories for books, journals, dissertations, historical collections, and cultural memory.",
    "items": [
      {
        "name": "WorldCat",
  ...
  },
  {
    ...
    "color": "#fb7185",
    "description": "Institutional knowledge systems for laws, public records, government documents, and technical invention.",
    "items": [
      {
        "name": "LexisNexis",
  ...
  },
  {
    ...
    "color": "#22d3ee",
    "description": "Open datasets, economic time series, global indicators, and news event databases.",
    "items": [
      {
  ...
  },
  {
    ...
    "color": "#f472b6",
    "description": "Large public platforms whose archives function as informal databases of video, discussion, technical problem-solving, and real-time discourse.",
    "items": [
      {
        "name": "YouTube",
  ...
  },
  {
    ...
    "color": "#c4b5fd",
    "description": "Meta-catalogs that already track data repositories, open-access repositories, and scientific standards.",
    "items": [
      {
        "name": "re3data",
...
export const dataIndexCategories: DataIndexCategory[] = dataIndexCatalog.map((section) => ({
  name: section.name,
  color: section.color,
...
export const dataIndexEntryCount = dataIndexCatalog.reduce(
